...
pub async fn connect_tunnel(
    ...
    phantom_protocol::FrameReader<tokio::io::ReadHalf<TcpStream>>,
    phantom_protocol::FrameWriter<tokio::io::WriteHalf<TcpStream>>,
    u32,
)> {
    use phantom_crypto::{NoiseInitiator, split_after_handshake};
    ...
    let transport = phantom_transport::tcp::TcpTransport::new(std::time::Duration::from_secs(10));
